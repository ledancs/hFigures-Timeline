...
function HealthGraph(groups, w, className){
    ...
    // Other options
    var outerRadius = w * 0.45; // check a scale function from d3
    var innerRadius = w * 0.30;
    var defaultLabelRadius = w * 0.5;

    var groupLabelFontSize = 48;
    var measurementLabelFontSize = 32;
